...
-(void)setBottomRadius:(CGFloat)bottomRadius{
    ...
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:self.bounds byRoundingCorners:(  UIRectCornerBottomLeft | UIRectCornerBottomRight) cornerRadii:CGSizeMake(bottomRadius, bottomRadius)];
...
-(void)setTopLeftCornerRadius:(CGFloat)Radius{
...
-(void)setTopRightCornerRadius:(CGFloat)Radius{
    
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:self.bounds byRoundingCorners:(  UIRectCornerTopRight ) cornerRadii:CGSizeMake(Radius, Radius)];
